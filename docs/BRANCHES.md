...
| --- | --- | --- | --- |
| `antigravity` | Google Antigravity (`agy`) | `antigravity-feishu-bridge` | `scripts/bootstrap-antigravity-bridge.ps1` then `scripts/run-antigravity-bridge.ps1` |
...
Deployment branches use short, stable agent names. Feature work uses
