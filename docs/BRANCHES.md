...
| --- | --- | --- | --- |
| `bridge/antigravity` | Google Antigravity (`agy`) | `antigravity-feishu-bridge` | `scripts/run-antigravity-bridge.ps1` |
...
`feature/<topic>` branches and is merged into its matching `bridge/<agent>`
branch only after validation.
