# DeepSeek Harness Feishu Bridge for Windows
...
> deployment workflow for DeepSeek Harness (`dsh`).
...
Detailed Windows notes are in
[docs/DEEPSEEK_HARNESS_WINDOWS_BRIDGE.md](./docs/DEEPSEEK_HARNESS_WINDOWS_BRIDGE.md).

A lightweight bot that bridges Feishu / Lark messenger with your local
DeepSeek Harness CLI. Run one command, scan a QR code to bind a PersonalAgent
app, and talk to your local coding agent from chat.
